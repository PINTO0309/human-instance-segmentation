...
class ConfigManager:
    ...
    CONFIGS = {
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r112x84m112x84': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r112x84m112x84',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:112x84 (H:W), Mask:112x84 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
                roi_size=(112, 84),  # (height, width) - matches dataset's natural aspect ratio
                mask_size=(112, 84),  # (height, width) - matches dataset's natural aspect ratio
                onnx_model=None,
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/2020-09-23a.pth",
