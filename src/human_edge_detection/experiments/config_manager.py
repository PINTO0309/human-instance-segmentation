...
class ModelConfig:
    ...
    hierarchical_base_channels: int = 64  # Base channels for EnhancedUNet in hierarchical head (default 64, can increase to 96, 128)
    hierarchical_depth: int = 3  # Depth of EnhancedUNet in hierarchical head (default 3, can increase to 4)
...
class ConfigManager:
    ...
    CONFIGS = {
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r32x24m64x48_disttrans_contdet_baware_from_B0': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r32x24m64x48_disttrans_contdet_baware_from_B0',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:32x24 (H:W), Mask:64x48 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
                roi_size=(32, 24),  # (height, width) - matches dataset's natural aspect ratio
                mask_size=(64, 48),  # (height, width) - matches dataset's natural aspect ratio
                onnx_model=None,
                # Pre-trained model configuration
                use_pretrained_unet=True,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r96x72m192x144_disttrans_contdet_baware_from_B0': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r96x72m192x144_disttrans_contdet_baware_from_B0',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:96x72 (H:W), Mask:192x144 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
                roi_size=(96, 72),  # (height, width) - matches dataset's natural aspect ratio
                mask_size=(192, 144),  # (height, width) - matches dataset's natural aspect ratio
                onnx_model=None,
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b0_0.8741.pth",  # Using B0 model
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r112x84m224x168_disttrans_contdet_baware_from_B0': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r112x84m224x168_disttrans_contdet_baware_from_B0',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:112x84 (H:W), Mask:224x168 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
                roi_size=(112, 84),  # (height, width) - matches dataset's natural aspect ratio
                mask_size=(224, 168),  # (height, width) - matches dataset's natural aspect ratio
                onnx_model=None,
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b0_0.8741.pth",  # Using B0 model
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r128x96m256x192_disttrans_contdet_baware_from_B0': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r128x96m256x192_disttrans_contdet_baware_from_B0',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:128x96 (H:W), Mask:256x192 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
                roi_size=(128, 96),  # (height, width) - matches dataset's natural aspect ratio
                mask_size=(256, 192),  # (height, width) - matches dataset's natural aspect ratio
                onnx_model=None,
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b0_0.8741.pth",  # Using B0 model
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r32x24m64x48_disttrans_contdet_baware_from_B1': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r32x24m64x48_disttrans_contdet_baware_from_B1',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:32x24 (H:W), Mask:64x48 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r96x72m192x144_disttrans_contdet_baware_from_B1': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r96x72m192x144_disttrans_contdet_baware_from_B1',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:96x72 (H:W), Mask:192x144 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r112x84m224x168_disttrans_contdet_baware_from_B1': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r112x84m224x168_disttrans_contdet_baware_from_B1',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:112x84 (H:W), Mask:224x168 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r128x96m256x192_disttrans_contdet_baware_from_B1': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r128x96m256x192_disttrans_contdet_baware_from_B1',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:128x96 (H:W), Mask:256x192 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B7': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B7',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48 (H:W), Mask:128x96 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                ...
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b7_0.9009.pth", #"ext_extractor/2020-09-23a.pth",
                freeze_pretrained_weights=True,
                use_full_image_unet=True,  # Apply UNet to full image first
                # Refinement modules (disabled for pre-trained model)
                use_boundary_refinement=False, # x
                ...
                activation_function='relu',  # Options: 'relu', 'swish', 'gelu', 'silu'
                activation_beta=1.0,  # Beta parameter for Swish activation
                # Encoder configuration for B7 model
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B7': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B7',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:80x60 (H:W), Mask:160x120 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                ...
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b7_0.9009.pth",  # Using B1 model
                freeze_pretrained_weights=True,
                use_full_image_unet=True,  # Apply UNet to full image first
                # Refinement modules (disabled for pre-trained model)
                use_boundary_refinement=False, # x
        ...
        ##################################################################################################
        # Enhanced hierarchical configurations with increased base_channels and depth
        ##################################################################################################
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B0_enhanced': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B0_enhanced',
            description='Enhanced RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48, Mask:128x96',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
                ...
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b0_0.8741.pth",
                freeze_pretrained_weights=True,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B0_enhanced': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B0_enhanced',
            description='Enhanced RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:80x60, Mask:160x120',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                use_attention_module=True,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B1_enhanced': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B1_enhanced',
            description='Enhanced RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48, Mask:128x96',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                ...
                # Pre-trained model configuration
                use_pretrained_unet=True,
                pretrained_weights_path="ext_extractor/best_model_b1_0.8833.pth",
                freeze_pretrained_weights=True,
                use_full_image_unet=True,
                # Enhanced hierarchical head configuration
                hierarchical_base_channels=72,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B1_enhanced': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B1_enhanced',
            description='Enhanced RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:80x60, Mask:160x120',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B7_enhanced': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m128x96_disttrans_contdet_baware_from_B7_enhanced',
            description='Enhanced RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48, Mask:128x96',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B7_enhanced': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r80x60m160x120_disttrans_contdet_baware_from_B7_enhanced',
            description='Enhanced RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:80x60, Mask:160x120',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_distillation_b0_from_b3_temp': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b0_from_b3_temp',
            description='UNet encoder only distillation from B3 teacher to B0 student',
            model=ModelConfig(
                # Use special flag for UNet-only distillation
                use_unet_encoder_only=True,
        ...
        # Knowledge distillation with temperature scheduling and progressive unfreezing
        'rgb_hierarchical_unet_v2_distillation_b0_from_b3_temp_prog': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b0_from_b3_temp_prog',
        ...
        'rgb_hierarchical_unet_v2_distillation_b0_from_b7_temp_prog': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b0_from_b7_temp_prog',
            description='UNet distillation with temperature scheduling and progressive encoder unfreezing',
            model=ModelConfig(
                # Use special flag for UNet-only distillation
                use_unet_encoder_only=True,
        ...
        'rgb_hierarchical_unet_v2_distillation_b1_from_b3_temp_prog': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b1_from_b3_temp_prog',
            description='UNet distillation with temperature scheduling and progressive encoder unfreezing',
            model=ModelConfig(
                # Use special flag for UNet-only distillation
                use_unet_encoder_only=True,
        ...
        'rgb_hierarchical_unet_v2_distillation_b1_from_b7_temp_prog': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b1_from_b7_temp_prog',
            description='UNet distillation with temperature scheduling and progressive encoder unfreezing',
            model=ModelConfig(
                # Use special flag for UNet-only distillation
                use_unet_encoder_only=True,
        ...
        'rgb_hierarchical_unet_v2_distillation_b6_from_b7_temp_prog': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b6_from_b7_temp_prog',
            description='UNet distillation with temperature scheduling and progressive encoder unfreezing',
            model=ModelConfig(
                # Use special flag for UNet-only distillation
                use_unet_encoder_only=True,
            ...
            distillation=DistillationConfig(
                enabled=True,
                teacher_encoder="timm-efficientnet-b7",
                teacher_checkpoint="ext_extractor/best_model_b7_0.9005.pth",  # Teacher B3 weights
                temperature=4.0,  # Initial temperature for softer distributions
                alpha=0.3,  # Lower weight for distillation, more on ground truth
                encoder_only_epochs=0,
                distill_logits=True,
                ...
                freeze_teacher=True,
                student_encoder="timm-efficientnet-b6"
            ),
            data=DataConfig(
                train_annotation="data/annotations/instances_train2017_person_only_no_crowd.json",
                val_annotation="data/annotations/instances_val2017_person_only_no_crowd.json",
        ...
        'rgb_hierarchical_unet_v2_distillation_b7_from_b3_temp_prog': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_distillation_b7_from_b3_temp_prog',
            description='UNet distillation with temperature scheduling and progressive encoder unfreezing',
            model=ModelConfig(
                # Use special flag for UNet-only distillation
                use_unet_encoder_only=True,
        ...
        'rgb_hierarchical_unet_v2_distillation_b0_from_b3_yolo': ExperimentConfig(
            ...
            training=TrainingConfig(
                ...
                batch_size=4,  # Larger batch size for stable distillation
                gradient_clip=5.0,  # Higher clip threshold
                dice_weight=1.0,  # Keep dice loss
