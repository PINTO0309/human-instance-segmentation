...
class ConfigManager:
    ...
    CONFIGS = {
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m64x48_disttrans': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m64x48_disttrans',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48 (H:W), Mask:64x48 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m64x48_disttrans_contdet': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m64x48_disttrans_contdet',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48 (H:W), Mask:64x48 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
        ...
        'rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m64x48_disttrans_contdet_actcont': ExperimentConfig(
            name='rgb_hierarchical_unet_v2_fullimage_pretrained_peopleseg_r64x48m64x48_disttrans_contdet_actcont',
            description='RGB Hierarchical UNet V2 with Full-Image Pre-trained People Segmentation Model - ROI:64x48 (H:W), Mask:64x48 (H:W)',
            model=ModelConfig(
                use_rgb_hierarchical=True,
                use_external_features=False,
                ...
                use_boundary_aware_loss=False,
                use_contour_detection=True,
                use_active_contour_loss=True, # x
                use_distance_transform=True,
                use_progressive_upsampling=False,
                use_subpixel_conv=False,
                # Normalization type is ignored for pre-trained model
